...
<div class="container my-5">
    ...
    <div class="card p-4" id="invoice">
            ...
            <tbody>
                ...
                @foreach($order->items as $item)
                    ...
                    <tr>
                        <td>
                            @if($item->food_image)
                                <img src="{{ asset('storage/foods/'.$item->food_image) }}" height="50">
                            @endif
                        </td>
                ...
                <tr>
                    ...
                    <td>- $0.00</td> {{-- add logic if needed --}}
                </tr>
                @endif
                <tr>
        ...
        <div class="d-flex gap-2 mt-3">
            ...
            <a href="{{ route('orders.history') }}" class="btn btn-primary">Back to Orders</a>
        </div>
    </div>
</div>
@endsection
...
/* Optional: Order progress hover effect */
.d-flex > div:hover { transform: scale(1.05); transition: transform 0.2s; }
</style>
@endsection
